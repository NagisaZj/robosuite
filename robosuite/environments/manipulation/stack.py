...
class Stack(SingleArmEnv):
    ...
    def staged_rewards(self):
        ...
        if cubeA_lifted:
            ...
            self.align_reward += 0.5 * (1 - np.tanh(horiz_dist))
    ...
    def _post_action(self, action):
        ...
        if self.get_info:
            info['add_vals'] = ['lift_times', 'hold_times', 'align_reward','stack_times']
            info['lift_times'] = self.lift_times
            info['hold_times'] = self.hold_times
            info['align_reward'] = self.align_reward
            info['stack_times'] = self.stack_times
